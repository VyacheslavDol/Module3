...
int main(int argc, char* argv[])
{
    ...
    sem0 = sem_open(SEM0_NAME, O_CREAT, 0664, NUM_ACCESS); // 0 - кол-во процессов которые читают файл в данный момент времени; 1 - доступ (0/1);
